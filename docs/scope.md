...
| Punkt | Einordnung |
|---|---|
| Anmeldung in einem Google-Konto stürzt ab | offen, noch nicht untersucht |
| Sporadischer Fehlschlag beim Laden einer Erweiterung | Wiederholung behebt es |
| Verwaiste Kopien unter `UnpackedExtensions` | Aufräumlauf fehlt |
...
- Aufräumlauf für verwaiste Kopien
